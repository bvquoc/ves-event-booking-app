...
public class ApplicationInitConfig {
    ...
    private void seedSampleEvents(
        ...
        Event pastConcert = Event.builder()
                ...
                .category(musicCat)
                .thumbnail("https://news.vio.vn/wp-content/uploads/2023/06/cach-mua-ve-concert-blackpink-2-1.jpg?auto=format&fit=crop&w=800&q=80")
        ...
        Event pastMatch = Event.builder()
                ...
                .category(sportsCat)
                .thumbnail("https://image.vietnamnews.vn/uploadvnnews/Article/2023/1/13/261926_4428682249743478_image.png?auto=format&fit=crop&w=800&q=80")
        ...
        Event ongoingTheater = Event.builder()
                ...
                .category(theaterCat)
                .thumbnail("https://media.urbanistnetwork.com/urbanisthanoi/article-images/2021/12/theater/00b.jpg?auto=format&fit=crop&w=800&q=80")
        ...
        Event soldOutEvent = Event.builder()
                ...
                .category(musicCat)
                .thumbnail("https://images.unsplash.com/photo-1692796226663-dd49d738f43c?auto=format&fit=crop&w=800&q=80")
        ...
        Event futureEvent = Event.builder()
                ...
                .category(sportsCat)
                .thumbnail("https://cdnmedia.baotintuc.vn/Upload/YZmStSDTjb0M07hFJ2gA/files/2025/11/01/seagames-051125-1.jpg?auto=format&fit=crop&w=800&q=80")
